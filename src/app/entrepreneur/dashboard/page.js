  ...
  return (
    <DashboardLayout persona="entrepreneur">
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="bg-white p-6 rounded-lg border border-gray-200">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">Recent Business Updates</h2>
            <div className="space-y-4">
              <div className="flex items-start space-x-4 p-4 bg-gray-50 rounded-lg">
                ...
                <div className="flex-1">
                  <p className="font-medium text-gray-900">New partnership formed</p>
                  <p className="text-sm text-gray-600">Collaboration with GreenTech Solutions</p>
                  <p className="text-xs text-gray-400">Formed 2 days ago</p>
                </div>
              </div>
              <div className="flex items-start space-x-4 p-4 bg-gray-50 rounded-lg">
                <div className="flex-shrink-0">
                ...
                <div className="flex-1">
                  <p className="font-medium text-gray-900">Investment round closed</p>
                  <p className="text-sm text-gray-600">$2.1M raised for TechFlow Startup</p>
                  <p className="text-xs text-gray-400">Closed 1 week ago</p>
                </div>
              </div>
              <div className="flex items-start space-x-4 p-4 bg-gray-50 rounded-lg">
                <div className="flex-shrink-0">
                ...
                <div className="flex-1">
                  <p className="font-medium text-gray-900">Market report published</p>
                  <p className="text-sm text-gray-600">Q4 AI/ML market growth analysis</p>
