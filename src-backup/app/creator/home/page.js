  ...
  return (
    <DashboardLayout persona="creator">
      <div className="space-y-6">
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-200">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Recent Creative Updates</h2>
          <div className="space-y-4">
            <div className="flex items-start space-x-4 p-4 bg-gray-50 rounded-lg">
              ...
              <div className="flex-1">
                <p className="font-medium text-gray-900">New design published</p>
                <p className="text-sm text-gray-600">"Minimalist UI Kit" on Dribbble</p>
            ...
            <div className="flex items-start space-x-4 p-4 bg-gray-50 rounded-lg">
              ...
              <div className="flex-1">
                <p className="font-medium text-gray-900">Video tutorial released</p>
                <p className="text-sm text-gray-600">"Editing Cinematic Videos" on YouTube</p>
            ...
            <div className="flex items-start space-x-4 p-4 bg-gray-50 rounded-lg">
              ...
              <div className="flex-1">
                <p className="font-medium text-gray-900">Photo featured</p>
                <p className="text-sm text-gray-600">"Sunset Over Mountains" on Unsplash</p>
                <p className="text-xs text-gray-400">Featured 1 week ago</p>
              </div>
            </div>
          </div>
        </div>
