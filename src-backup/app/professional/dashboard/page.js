  ...
  return (
    <DashboardLayout persona="professional">
      <div className="space-y-6">
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-200">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Recent Work Updates</h2>
          <div className="space-y-4">
            <div className="flex items-start space-x-4 p-4 bg-gray-50 rounded-lg">
              ...
              <div className="flex-1">
                <p className="font-medium text-gray-900">Project Alpha milestone reached</p>
                <p className="text-sm text-gray-600">Design phase completed</p>
            ...
            <div className="flex items-start space-x-4 p-4 bg-gray-50 rounded-lg">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600">Quarterly review with all team members</p>
            ...
            <div className="flex items-start space-x-4 p-4 bg-gray-50 rounded-lg">
              ...
              <div className="flex-1">
                <p className="font-medium text-gray-900">Client feedback received</p>
                <p className="text-sm text-gray-600">Positive feedback on recent deliverables</p>
                <p className="text-xs text-gray-400">Received 1 week ago</p>
              </div>
            </div>
          </div>
        </div>
